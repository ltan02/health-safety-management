...
export default function IncidentDetailField({incident, user, commentData, incidentId, customField, handleAddComment, handleEditCustomField, editingCustomField, setCustomField, handleSaveChanges, handleCancelChanges, comment, setComment, loading}) {
