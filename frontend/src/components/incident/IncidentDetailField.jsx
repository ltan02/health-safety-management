...
import { Box, Typography, FormControl, TextField, Button, Grid, Avatar, TextareaAutosize } from "@mui/material";
...
export default function IncidentDetailField({
    ...
    return (
        ...
        >
            <Typography id="issue-detail-modal-title" variant="h5" component="h2" sx={{ fontWeight: "bold" }}>
            ...
            <Box>
                ...
                >
                    ...
                    >
                        ...
                        />
                        <Button variant="outlined" sx={{ borderRadius: 10 }} color="primary" type="submit">
                            Submit
                        </Button>
                    </form>
                </Box>
